...
const SearchForm = () => {
	...
	return (
		<div className='d-flex pb-4'>
			<div className='w-100' value={location} onChange={(e) => setLocation(e.target.value)}>
			...
			<Select className='w-100' onChange={(value) => setBed(value)} size='large' placeholder='Number of beds'>
